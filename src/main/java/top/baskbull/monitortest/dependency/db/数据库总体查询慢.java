...
public class 数据库总体查询慢 {
    ...
    public static void main(String[] args) {
        ...
        metricTemplate.setName("数据库总体查询慢");
        ...
        qpm.setRightVal(Double.valueOf(6000));
        qpm.setQueryValFormat(0);
        qpm.setQueryValCompareStrategy(0);

        rt.setName("每分钟数据库执行P75-RT");
        rt.setQueryMql("sql.rt_centroid_by_app{appReporter=\"{{ appReporter }}\"}${timeRange:TIME_RANGE} | time_aggr<${slidingWindow:SLIDING_WINDOW}, centroid<20>> | tag_aggr<[], quantile<[75]>>");
        rt.setTargetTagName("appReporter");
        rt.setDetectionMethod("THRESHOLD");
        rt.setComparisonOperator("GTE");
        rt.setRightVal(600.0);
