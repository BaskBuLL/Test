...
public class 消息推送总体失败率较高 {
    ...
    public static void main(String[] args) {
        ...
        metricTemplate.setName("消息推送总体失败率较高");
        ...
        metricTemplate.setContinuousCount(5);
        ...
        failRate.setQueryMql("bifrost-push-admin.msg-push.fail_rate{clientId=\"{{ clientId }}\"}${timeRange:TIME_RANGE} | time_aggr<${slidingWindow:SLIDING_WINDOW}, sum> | tag_aggr<[], sum>");
