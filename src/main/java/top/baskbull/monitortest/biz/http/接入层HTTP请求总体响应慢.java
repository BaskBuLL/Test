...
public class 接入层HTTP请求总体响应慢 {
    ...
    public static void main(String[] args) {
        ...
        metricTemplate.setName("接入层HTTP请求总体响应慢");
        ...
        rt.setName("调用P50-RT");
        rt.setQueryMql("watchtower-gateway.app.rt_centroid{appName=\"{{ appName }}\"}${timeRange:TIME_RANGE} | time_aggr<${slidingWindow:SLIDING_WINDOW}, centroid<20>> | tag_aggr<[], quantile<[50]>>");
